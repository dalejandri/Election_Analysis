...
with open(file_to_save, "w") as election_analysis:
    ...
    for county_name in county_votes:
        ...
        election_analysis.write(county_total)

        # 6f: Write an if statement to determine the winning county and get its vote count.
        if(county_votes_count > largest_county_vote) and (county_vote_percentage > largest_county_percentage):
            largest_county_vote = county_votes_count
